...
export const setDensity = (density) => {
  setStorage(STORAGE_KEYS.DENSITY, density);
};
...
export const getDensity = () => {
  return getStorage(STORAGE_KEYS.DENSITY, 'comfortable');
};
 ...
 */
export const setAnimations = (enabled) => {
  setStorage(STORAGE_KEYS.ANIMATIONS, enabled);
};
...
export const getAnimations = () => {
  return getStorage(STORAGE_KEYS.ANIMATIONS, true);
};
...
export const setCookieConsent = (consent) => {
  setStorage(STORAGE_KEYS.COOKIE_CONSENT, consent);
};
...
export const getCookieConsent = () => {
  return getStorage(STORAGE_KEYS.COOKIE_CONSENT, {
    essential: true,
    functional: false,
    analytics: false,
    marketing: false
...
/**
 * Check if cookie consent given for specific type
 ...
 * @param {boolean} completed - Onboarding completed
 */
export const setOnboardingCompleted = (completed = true) => {
  setStorage(STORAGE_KEYS.ONBOARDING_COMPLETED, completed);
};
...
export const isOnboardingCompleted = () => {
  return getStorage(STORAGE_KEYS.ONBOARDING_COMPLETED, false);
};
